...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    const baseStyles =
      ...
      "rounded-lg font-semibold transition-all focus-visible:outline-none " +
    ...
    const sizes = {
      ...
      default:
        "min-h-[44px] sm:min-h-[36px] h-11 sm:h-9 px-4 py-2 " +
        "text-sm sm:text-xs",
      lg:
        "min-h-[48px] sm:min-h-[40px] h-12 sm:h-10 px-6 " +
