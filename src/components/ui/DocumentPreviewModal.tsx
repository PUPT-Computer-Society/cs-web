...
export const DocumentPreviewModal: React.FC<DocumentPreviewModalProps> = ({
  ...
  const effectiveTitle =
    title || cachedPropsRef.current.title || "Document Preview";
  const effectiveUrl = url || cachedPropsRef.current.url || "";
  const effectiveSubtitle = subtitle ?? cachedPropsRef.current.subtitle;
  ...
  const displayTitle =
    effectiveFileMeta?.title || effectiveTitle || "Document Preview";
  const displayFileName =
    effectiveFileMeta?.fileName ||
    (effectiveUrl
      ? effectiveUrl.split("/").pop()?.split("?")[0]
      : undefined) ||
    displayTitle;
  ...
  return (
    <Dialog
      ...
      description={
        effectiveSubtitle ||
        "In-portal document inspection with file metadata and Google Drive."
      }
      ...
      <div className="flex flex-col space-y-3 pt-1">
        ...
        <div
          className={cn(
            ...
            "rounded-xl bg-secondary/30 border border-border/70 text-xs",
          )}
        >
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={cn(
                ...
                "hover:text-foreground cursor-pointer flex items-center gap-1",
              )}
        ...
        {/* Split View: Left Document Info Sidebar + Right Preview Frame */}
        <div
          className={cn(
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {effectiveFileMeta?.category && (
                    ...
                    >
                      ...
                      <span>{effectiveFileMeta.category}</span>
                    </Badge>
                  )}
                  {effectiveFileMeta?.fileType && (
                    <Badge
                      variant="outline"
              ...
              <div className="space-y-2.5 pb-3 border-b border-border/60">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "font-mono font-medium text-foreground text-right",
                        "break-all text-[11px]",
                      )}
                    >
                      {displayFileName}
                  ...
                  {effectiveFileMeta?.dateUploaded && (
                    <div
                      className="flex items-start justify-between gap-2 text-xs"
                    >
                      <span
                  ...
                  {effectiveFileMeta?.authorOrUploader && (
                    <div
                      className="flex items-start justify-between gap-2 text-xs"
                    >
                      <span
                  ...
                  {effectiveFileMeta?.customFields?.map((field, fIdx) => (
                    <div
                      key={`custom-${fIdx}`}
                      className="flex items-start justify-between gap-2 text-xs"
                    >
              ...
              <div className="space-y-1.5 flex-1 min-h-0">
                ...
                <div
                  className={cn(
                    ...
                    "border-border/50 max-h-56 overflow-y-auto",
                  )}
                >
                  <MarkdownRenderer
                    content={effectiveFileMeta?.description}
          ...
          >
            ...
            <div
              className={cn(
                ...
                "bg-amber-500/10 border-b border-amber-500/20 text-[11px]",
                  ...
                  {isLoadingIframe && (
                    <div
                      className={cn(
                        ...
                        "justify-center gap-2 bg-card/85 backdrop-blur-xs z-10",
                        "text-muted-foreground text-xs",
                      )}
                    >
                      <div
                        className={cn(
                          "w-6 h-6 border-2 border-primary",
        ...
        <div
          className={cn(
            ...
            "sm:items-center gap-2 pt-1 text-xs text-muted-foreground",
